const portfolioData = {
  ...
  ui: {
    id: {
      ...
      noteText:
        "Saat ini saya membangun fondasi di machine learning, forecasting, NLP, dan analisis data sambil tetap membawa pengalaman backend yang rapi dan terstruktur.",
    ...
    en: {
      ...
      projectsDescription:
        "This section highlights the projects I use to strengthen supervised learning, unsupervised learning, NLP, time series forecasting, and presentation-ready data analysis.",
      ...
      noteTitle: "Data scientist focus",
      noteText:
        "I am currently building stronger foundations in machine learning, forecasting, NLP, and data analysis while still bringing structured backend experience.",
  ...
  projects: {
    id: [
      ...
      },
      {
        ...
        links: [{ type: "repository", href: "https://github.com/muhfajri24/Restaurant-Sales-Insight" }],
      },
      {
