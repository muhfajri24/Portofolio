const portfolioData = {
  ...
  personal: {
    ...
    about: {
      id: "Saya terbiasa belajar lewat studi kasus, mengerjakan project end-to-end, dan menjaga agar solusi tetap mudah dipahami. Pengalaman organisasi membuat saya nyaman memimpin, berkoordinasi, dan mengambil keputusan secara kolaboratif, sementara project teknis membuat saya terbiasa merapikan detail implementasi. Saya tertarik pada peran yang menggabungkan pemikiran analitis dengan kemampuan membangun sistem, khususnya di area data dan backend. Karena itu, saya senang ketika sebuah project tidak hanya selesai secara teknis, tetapi juga punya alur yang jelas, tujuan yang terukur, dan hasil yang bisa dipresentasikan dengan baik kepada orang lain. Bagi saya, proses belajar yang paling berharga adalah ketika saya bisa mengubah masalah nyata menjadi solusi yang rapi, berguna, dan terus bisa dikembangkan.",
      en: "I am used to learning through case studies, completing projects end-to-end, and keeping solutions easy to understand. My organizational experience makes me comfortable leading, coordinating, and making collaborative decisions, while technical projects keep me disciplined around implementation details. I am especially interested in roles that combine analytical thinking with system building, particularly in data and backend work. Because of that, I enjoy projects that are not only technically complete, but also have a clear flow, measurable purpose, and results that can be presented well to other people. For me, the most valuable learning happens when I can turn real problems into solutions that are structured, useful, and still open for future improvement.",
    },
    currentLabel: {
      id: "Sorotan Peran",
      en: "Featured Role",
