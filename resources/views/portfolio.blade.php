...
<html lang="id">
    <head>
        ...
        <meta
            name="description"
            content="Data Scientist portfolio of Muhammad Fajri, featuring machine learning, forecasting, NLP, data science projects, and a structured backend foundation."
        >
    ...
    <body>
        ...
        <header class="site-header">
            <div class="header-shell">
                ...
                <nav class="site-nav" aria-label="Navigasi utama">
                    ...
                    <a href="#projects" id="nav-projects">Project</a>
        ...
        <main>
            ...
            <section class="section" id="projects">
                <div class="section-heading" data-reveal>
                    <p class="eyebrow" id="projects-eyebrow">Project</p>
